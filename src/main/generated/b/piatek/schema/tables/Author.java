...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.author.nationality</code>.
     */
    public final TableField<AuthorRecord, String> NATIONALITY = createField(DSL.name("nationality"), SQLDataType.VARCHAR, this, "");
